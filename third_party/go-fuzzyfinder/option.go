...
const (
	// LayoutBottom anchors the item list to the bottom of the terminal and
	// grows it upward. It is the default layout.
	LayoutBottom layout = iota
	// LayoutReverse anchors the item list to the top of the terminal and
	// grows it downward.
	LayoutReverse
)

// WithLayout specifies where the item list is anchored. The default is
// LayoutBottom.
